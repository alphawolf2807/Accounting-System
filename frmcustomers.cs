...
namespace SimpleaccountingSys
{
    public partial class frmcustomers : Form
    {
        ...
        private void saveonebutton_Click(object sender, EventArgs e)
        {
            ...
            string cb2 = "insert into Customers (Customer_name,Phone,Address,is_deleted) values(@a1,@a2,@a3,0) ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string cb2 = "update Customers set Customer_name=@a1,Phone=@a2,Address=@a4 where Cus_id=@a3 and isnull(is_deleted,0)=0";
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string activitylog = "select * from Customers where Cus_id=@a1 and isnull(is_deleted,0)=0";//select item to update based on id selected from grid
        ...
        void load()
        {
            ...
            string cb2 = "select * from Customers where isnull(is_deleted,0)=0 ";
        ...
        private void oktwobutton_Click(object sender, EventArgs e)
        {
            ...
            string cq1b = "update customers set is_deleted = 1 where cus_id=@a1";
