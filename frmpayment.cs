    ...
    public partial class frmpayment : Form
    {
        ...
        void Chartofaccounts()
        {
            ...
            string cmdStringbunit = " select Account_id,Account" +
                    " from Accounts where   isnull(is_deleted,0) = 0";
            SqlConnection myconnection = new SqlConnection(cs.DBConn);
            myconnection.Open();
            SqlCommand sqlCommandbunit = new SqlCommand(cmdStringbunit, myconnection);
        ...
        void customernm()
        {
            ...
            string cmdStringbunit = " select Cus_id,Customer_name" +
                    " from Customers  where isnull(Customers.is_deleted,0) = 0";
            SqlConnection myconnection = new SqlConnection(cs.DBConn);
            myconnection.Open();
            SqlCommand sqlCommandbunit = new SqlCommand(cmdStringbunit, myconnection);
        ...
        void getdata()
        {
            ...
            string cb2 = "select TFinancials.names as Name,TFinancials.FDate as Date,Cash_Bank.Cash_type," +
             ...
             " inner join Cash_Bank ON TFinancials.id = Cash_Bank.id where TFinancials.FDate>=@a1 and TFinancials.FDate<=@a2 AND FCREDIT <> 0 and isnull(Cash_Bank.is_deleted,0) = 0   and isnull(TFinancials.is_deleted,0) = 0";
        ...
        private void saveonebutton_Click(object sender, EventArgs e)
        {
            ...
            string cb2 = "insert Into TFinancials(FDate,CID,id,Particular," +
                       "FCredit,FDebit,names,Account_id,is_deleted)" +
             " VALUES (@FDate,@CID,@id,@Particular,@FCredit,@FDebit,@names,@Account_id,0)";

            cmd = new SqlCommand(cb2);
            cmd.Connection = con;

            cmd.Parameters.AddWithValue("@FDate", dtpInvoiceDateFrom.Value);
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
           ...
           " inner join Cash_Bank ON TFinancials.id = Cash_Bank.id where TFinancials.FID=@a1 and isnull(TFinancials.is_deleted,0) = 0  and isnull(Cash_Bank.is_deleted,0) = 0";
            ...
            while (rdr.Read())
            {
                ...
                comboBox1acct.SelectedValue = Convert.ToInt32(rdr[0].ToString().Trim());
                ...
                comboBox1accts.SelectedValue = Convert.ToInt32(rdr[6].ToString().Trim());
        ...
        private void oktwobutton_Click(object sender, EventArgs e)
        {
            ...
            string cq1b = "update TFinancials set is_deleted = 1 where FID=@a1";
