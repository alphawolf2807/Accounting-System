    ...
    public partial class frmReceiptVoucher : Form
    {
        ...
        void getdata()
        {
            ...
            string cb2 = "select TFinancials.names as Name,TFinancials.FDate as Date,Cash_Bank.Cash_type," +
             ...
             " inner join Cash_Bank ON TFinancials.id = Cash_Bank.id where TFinancials.FDate>=@a1 and TFinancials.FDate<=@a2 AND FDEBIT <> 0 and isnull(TFinancials.is_deleted,0) = 0 and isnull(Cash_Bank.is_deleted,0) = 0 ";
        ...
        //private void saveonebutton_Click_1(object sender, EventArgs e)
        //{
