...
namespace E_examination
{
    public partial class MDIParent1 : Form
    {
        ...
        {
            frmReceiptVoucher myview = new frmReceiptVoucher();
            myview.ShowDialog();
        }

        private void journalJournalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmJournalEntry myview = new frmJournalEntry();
            myview.ShowDialog();
        }
    }
}
